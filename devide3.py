...
def filter_contours(contours, binary_img, min_aspect_ratio=0.1, max_aspect_ratio=3.0, max_width_ratio=1 / 5,
                    max_height_ratio=0.95, min_width_ratio=0.01, min_height_ratio=1 / 10):
    filtered_contours = []
...
if __name__ == "__main__":
    ...
    parser.add_argument('--source', type=str, default='binary_images/IMG_20160611_150522_0.jpg', help='picture file')
