...
注：我再次声明：这个项目我认为并不优秀，甚至可以说是一坨屎，但是我为它投入了不少精力，我认为依然有一些可取的东西，即可以用来参考，希望这能帮到你。另外，我的这个项目涉及训练模型的部分使用到了GPU，希望你们的这个东西比较好，当然也可以用CPU，只不过更慢一些，而且需要调一下，关于需要的硬件以及相应驱动的配置，可以参考如下链接：  
-- https://www.cnblogs.com/zyly/p/16046558.html#_label0  
-- https://www.cnblogs.com/zyly/p/8532368.html#_label0_6  
