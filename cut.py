...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='datasets/test/IMG_0170.JPG',help='picture file')
    parser.add_argument('--label', type=str, default='runs/detect/exp27/labels/IMG_0170.txt', help='标定框坐标文件')
